...
class TrainLoopPoseNet:
    ...
    def run_loop(self):
        ...
        # NOTE: Deprecate PROX joint masking scheme here.
        if False:
            ...
            for dir in tqdm(prox_mask_dir_list):
                ...
                for i in range(n_clip):
                    ...
                    if mask_ratio >= 0.05:  # ignore clips with very few masks
                        ...
                        for key in self.train_dataloader.dataset.repr_list:
        ...
        for epoch in range(self.num_epochs):
            ...
            for batch in tqdm(self.train_dataloader):
                ...
                if epoch <= self.start_prox_mask_epoch:
                    raise DeprecationWarning("PROX masking schemes is not supported currently!")
