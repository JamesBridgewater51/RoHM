...
def main(args, writer, logdir, logger):
    ...
    train_dataset = DataloaderNymeria(preprocessed_amass_root=args.dataset_root, split='train',
    ...
    test_dataset = DataloaderNymeria(preprocessed_amass_root=args.dataset_root, split='test', spacing=2,
                                   body_model_path=args.body_model_path,
                                   repr_abs_only=False,
                                   input_noise=args.input_noise,
                                   noise_std_smplx_global_rot=args.noise_std_smplx_global_rot,
